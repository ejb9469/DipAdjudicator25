...
public class Judge {
    ...
    public static void main(String[] args) {
        ...
        /*judge.orders = new ArrayList<>();
        judge.orders.add(new Order(Nation.ENGLAND, UnitType.FLEET, Province.ENG, OrderType.MOVE, Province.Bre));
        judge.orders.add(new Order(Nation.FRANCE, UnitType.FLEET, Province.Bre, OrderType.MOVE, Province.MAO));
        judge.orders.add(new Order(Nation.ITALY, UnitType.FLEET, Province.MAO, OrderType.MOVE, Province.NAO));
        judge.orders.add(new Order(Nation.GERMANY, UnitType.FLEET, Province.Pic, OrderType.MOVE, Province.Bre));
        judge.orders.add(new Order(Nation.RUSSIA, UnitType.FLEET, Province.NAO, OrderType.MOVE, Province.IRI));
        //judge.orders.add(new Order(Nation.AUSTRIA, UnitType.FLEET, Province.IRI, OrderType.MOVE, Province.Wal));
        judge.orders.add(new Order(Nation.TURKEY, UnitType.FLEET, Province.Wal, OrderType.MOVE, Province.ENG));*/
        judge.orders.add(new Order(Nation.ENGLAND, UnitType.FLEET, Province.ENG, OrderType.MOVE, Province.Bre));
        judge.orders.add(new Order(Nation.FRANCE, UnitType.FLEET, Province.Bre, OrderType.MOVE, Province.MAO));
        judge.orders.add(new Order(Nation.ITALY, UnitType.FLEET, Province.MAO, OrderType.MOVE, Province.ENG));
        judge.orders.add(new Order(Nation.AUSTRIA, UnitType.FLEET, Province.Wal, OrderType.MOVE, Province.ENG));
        judge.orders.add(new Order(Nation.GERMANY, UnitType.FLEET, Province.IRI, OrderType.SUPPORT, Province.MAO, Province.ENG));
        for (Order order : judge.orders)
            judge.resolve(order, true);
        for (Order order : judge.orders)
